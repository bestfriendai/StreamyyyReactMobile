        ...
        >
          <Animated.View style={[styles.iconContainer, iconAnimatedStyle]}>
            <IconComponent
              ...
              fill={isActive && (tab.key === 'favorites' || tab.key === 'subscription') ? '#8B5CF6' : 'transparent'}
            />
          </Animated.View>
          <Animated.Text style={[styles.tabLabel, labelAnimatedStyle, { color: isActive ? '#8B5CF6' : '#9CA3AF' }]}>
            {tab.title}
          </Animated.Text>
        </TouchableOpacity>
      </Animated.View>
