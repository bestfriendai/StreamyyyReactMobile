...
with_node \
  ...
  --target "/Users/iamabillionaire/Desktop/untitled folder 2/ReactProject/ios/Pods/Target Support Files/Pods-MultiStreamViewer/ExpoModulesProvider.swift" \
  --entitlement "/Users/iamabillionaire/Desktop/untitled folder 2/ReactProject/ios/MultiStreamViewer/MultiStreamViewer.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
